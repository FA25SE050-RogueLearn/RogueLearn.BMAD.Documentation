...
erDiagram
	...
	Party }o--|| User : references
	PartyMember }o--|| Party : references
	User ||--|| PartyMember : references
	...
	User ||--o{ Guild : references
	Guild ||--o{ GuildMember : references
	GuildMember ||--|| User : references
